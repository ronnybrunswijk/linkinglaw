...
feature 'Sign Up', :devise do
  ...
  scenario 'visitor cannot sign up with invalid email address' do
    ...
    expect(page).to have_content I18n.t('nl.activerecord.errors.model.user.attributes.email.invalid')
  end
  ...
  scenario 'visitor cannot sign up without password' do
    ...
    expect(page).to have_content "Password moet opgegeven zijn"
  end
  ...
  scenario 'visitor cannot sign up with a short password' do
    ...
    expect(page).to have_content "Password is te kort"
  end
  ...
  scenario 'visitor cannot sign up without password confirmation' do
    ...
    expect(page).to have_content "Password confirmation komt niet overeen"
  end
