# language: nl
Functionaliteit: zoeken naar juridische professionals
		 
  @profiles
  Scenario: de anonieme bezoeker zoekt een juridische professional 
            die gevestigd is in een bepaalde regio
    Stel ik bevind als bezoeker op de home pagina van LinkingLaw
